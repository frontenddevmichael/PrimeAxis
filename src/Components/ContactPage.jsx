            ...
            <div className="contact__layout">
                ...
                <div className="contact__panel">
                    <div className="contact__panel-content">
                        ...
                        {/* ── Divider ── */}
                        <div className="contact__call-divider" aria-hidden="true">
                            <span className="contact__call-divider-line" />
                            <span className="contact__call-divider-label">or</span>
                            <span className="contact__call-divider-line" />
                        </div>

                        {/* ── CallBooking merged ── */}
                        <div className="contact__call">
                            <span className="contact__call-tag">Free Consultation</span>
                            <h3 className="contact__call-title">
                                Not ready to commit?<br />
                                <em>Let's talk first.</em>
                            </h3>
                            <p className="contact__call-desc">
                                No pressure, no pitch. Tell us what you're working on
                                and we'll tell you honestly if we can help — and how.
                            </p>
                            <a className="btn btn--gradient contact__call-btn"
                                href="https://wa.me/2349164300395?text=Hello!%20I'd%20like%20to%20book%20a%20free%20consultation%20with%20PrimeAxis."
                                target="_blank" rel="noopener noreferrer" data-magnetic>
                                Book a Free Call <span className="btn__arrow" aria-hidden="true">↗</span>
                            </a>
                            <p className="contact__call-footnote">
